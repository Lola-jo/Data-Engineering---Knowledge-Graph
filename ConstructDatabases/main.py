...
class KnowledgeGraph():
    def __init__(self):
        self.graph_ = Graph("bolt://43.156.52.96:7687", auth = ('neo4j', 'password'))
        self.matcher = NodeMatcher(self.graph_)

        self.militaryPath_ = r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/military.json"
        self.nodeLabels_ = ['气动布局', '生产单位', '研发单位','动力装置', '发动机', '产国', '飞行速度', '底盘类型', '发动机数量', '制造商']


        self.radarPath_ = r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/radarData.json"
    ...
    def exportData(self):
        file = open("/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/export/exportData.csv", "w", encoding='utf8',newline='')
    ...
    def createPRIType(self):
        with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/json/PRIType.json", "r", encoding = 'utf-8') as file:
            lines = file.readlines()
    ...
    def createTechSysType(self):
        with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/json/TechnicalSystemType.json", "r", encoding = 'utf-8') as file:
            lines = file.readlines()
    ...
    def createAntennaScanningType(self):
        with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/json/AntennaScanningType.json", "r", encoding = 'utf-8') as file:
            lines = file.readlines()
    ...
    def createPWType(self):
        with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/json/PWType.json", "r", encoding = 'utf-8') as file:
            lines = file.readlines()
    ...
    def createPulseModeType(self):
        with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/json/PulseModeType.json", "r", encoding = 'utf-8') as file:
            lines = file.readlines()
    ...
    def createPolarizationType(self):
        with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/json/PolarizationType.json", "r", encoding = 'utf-8') as file:
            lines = file.readlines()
    ...
    def readMoziData(self):
        ...
        def readMoziAircraftData(self):
            ...
            with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/Mozi/MoziAircraftData.json", 'r', encoding = 'utf-8') as file:
                lines = file.readlines()
        ...
        def readMoziRadarData(self):
            nations = [node['name'] for node in matcher.match('产国')]            
            with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/Mozi/MoziRadarData.json", 'r', encoding = 'utf-8') as file:
                lines = file.readlines()
            for line in tqdm.tqdm(lines):
                data = json.loads(line)
        ...
        def readMoziShipData(self):
            nations = [node['name'] for node in matcher.match('产国')]            
            with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/Mozi/MoziShipData.json", 'r', encoding = 'utf-8') as file:
                lines = file.readlines()
            for line in tqdm.tqdm(lines):
                data = json.loads(line)
        ...
        def readMoziWeaponData(self):
            nations = [node['name'] for node in matcher.match('产国')]            
            with open(r"/home/ubuntu/gitee/Military-KG/ConstructDatabases/data/Mozi/MoziWeaponData.json", 'r', encoding = 'utf-8') as file:
                lines = file.readlines()
            for line in tqdm.tqdm(lines):
                data = json.loads(line)
